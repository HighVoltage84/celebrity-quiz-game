...
import taylorSwiftImage from '@/assets/taylor-swift.png';
...
const TaylorSwift = () => {
  ...
  const handleQuizClick = () => {
    ...
    if (newClickCount === 10) {
      // 10 taps detected - reset and go back to Drake
      setClickCount(0);
      localStorage.removeItem('celebrityQuizTaylorSwiftShown');
      navigate('/TS7UeIc', { replace: true });
      return;
    }
